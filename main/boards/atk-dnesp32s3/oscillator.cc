...
__attribute__((unused)) static ledc_channel_t next_free_channel = LEDC_CHANNEL_0;
...
void Oscillator::Attach(int pin, bool rev) {
    ...
    ledc_channel_ = (ledc_channel_t)next_channel;
    next_channel++;

    ESP_LOGI(TAG, "Attach servo: GPIO%d -> LEDC channel %d", pin_, ledc_channel_);
